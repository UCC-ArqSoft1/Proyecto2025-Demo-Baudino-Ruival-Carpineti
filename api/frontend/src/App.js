  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/create-activity" element={<AdminRoute><ActivityForm mode="create" /></AdminRoute>} />
        <Route path="/admin/edit-activity/:id" element={<AdminRoute><ActivityForm mode="edit" /></AdminRoute>} />
      </Routes>
    </BrowserRouter>
  );
}
